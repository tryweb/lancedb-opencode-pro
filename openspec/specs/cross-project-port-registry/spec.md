# cross-project-port-registry Specification

## Purpose
Prevent host listen port collisions across multiple projects on the same machine by planning and persisting non-conflicting Docker Compose host-port assignments.
