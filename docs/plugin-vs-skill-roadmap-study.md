...
- 建議分類：**Skill**
- 原因：這比較像「如何把既有 runtime evidence 組裝成對人有感的摘要」，不是新的資料引擎。
...
2. **Skill-assisted**
   - 把 dashboard、weekly summary、操作流、標準化輸出交給 skill
...
4. 若要落地 BL-030，優先建立一個新的 dashboard/summary skill，而不是新增大型 plugin 子系統
